...
const EditProfile = ({user,SetOnEdit}) => {
    ...
    const initState = {
        website : '' , email:'', story:'', phone:'', address:'' , fullname:''
    }
    ...
    return(
        ...
        <div className="editprofile-content">
            ...
            <div className="editprofile-avatar">    
                ...
                <i className="fas fa-camera" onClick={selectupload}></i>
                <span>
            ...
            <div className="editprofile-userdata">
                <div className="editprofile-userdata-column1">
                ...
                <div className="editprofile-userdata-column2">
            ...
            <button onClick={handleSubmit} className="editbuttonsubmit"> Submit </button>
        </div>
        </div>
    )
}
